...
Compile:
    (msvc)
    $ cl scan-SoftwareBreakpoints.cpp
*/
...
bool antidebug_DetectBreakpoint_FuncBorder()
{
    ...
    auto   pCriticalFunction = reinterpret_cast<PUCHAR>(&CriticalFunction);
...
{
    /*
    @xathrya: it's preferrable to use antidebug_DetectBreakpoint_ScanUntilRet
    */

    check(antidebug_DetectBreakpoint_FuncBorder, "Checking Software Breakpoints (Function-Border)");
